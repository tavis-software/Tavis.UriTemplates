...
namespace UriTemplateTests
{
    public class UsageTests
    {
        ...
        public void ShouldAllowUriTemplateWithPathSegmentParameter()
        {
            ...
            string uriString = template.Resolve();
        ...
        public void ResolveOptionalAndRequiredQueryParameters()
        {
            ...
            string result = template.Resolve();
        ...
        {
            string url = new UriTemplate("/1/search/auto/{folder}{?query}")
        ...
        public void EncodingTest2()
        {
            ...
            string url = new UriTemplate("{/greeting}")
            ...
            string url2 = new UriTemplate("{/greeting}")
                .AddParameter("greeting", "hello/world")
                .Resolve();
            ...
            string url3 = new UriTemplate("{/greeting*}")
        ...
        public void EncodingTest3()
        {
            ...
            string url = new UriTemplate("/docs/salary.csv{?columns}")
            ...
            string url2 = new UriTemplate("/docs/salary.csv{?columns*}")
                .AddParameter("columns", new List<int> { 1, 2 })
                .Resolve();
        ...
        {
            string url = new UriTemplate("/emails{?params*}")
        ...
        {
            //log?a=b&c=4
            string url = new UriTemplate("/log?a={a}&c={c}")
                .AddParameter("a", "b")
                .AddParameter("c", "4")
                .Resolve();
        ...
        public void InvalidSpace()
        {
            ...
            try
            {
                new UriTemplate("/feeds/events{? fromId").Resolve();
            }
            catch (Exception e)
            {
                ex = e;
